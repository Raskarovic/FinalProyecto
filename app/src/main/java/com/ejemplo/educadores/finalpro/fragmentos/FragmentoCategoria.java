...
import com.ejemplo.educadores.finalpro.adaptador.AdaptadorCategorias;
...
public class FragmentoCategoria extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(com.ejemplo.educadores.finalpro.R.layout.fragmento_grupo_items, container, false);

        reciclador = (RecyclerView) view.findViewById(com.ejemplo.educadores.finalpro.R.id.reciclador);
